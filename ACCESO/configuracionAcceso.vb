Public Class configuracionAcceso
    ...
    Public Function recuperar(ByVal nombre As String) As CONFIGURACION
        Try
            ...
            getObject("select * from CONFIGURACIONES where nombre=""" & nombre & """", nuevo)
            Return nuevo
    ...
    Public Function recuperar() As List(Of CONFIGURACION)
        Try
            ...
            getCollection("select * from CONFIGURACIONES", lista)
            Return lista
        Catch ex As Exception
            Throw
        End Try
    ...
    Public Function insertar(ByVal entidad As CONFIGURACION) As String
        Try
            Return ExecuteIdentity("insert into CONFIGURACIONES (nombre, valor) values (""" & entidad.nombre & """,""" & entidad.valor & """)")
        Catch ex As Exception
            Throw
        End Try
    End Function
    ...
    Public Function actualizar(ByVal entidad As CONFIGURACION) As Boolean
        Try
            Return ExecuteNonQuery("UPDATE CONFIGURACIONES SET valor=""" & entidad.valor & """ WHERE nombre=""" & entidad.nombre & """")
        Catch ex As Exception
            Throw
        End Try
    End Function
